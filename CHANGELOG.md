...
- Restructure CLAUDE.md for better instruction adherence
- Migrate memory from Qdrant to file-based system
...
- Update development standard v1.2 → v2.0

### Fixed

- Address review findings in development standard v2.0
...
- Replace Python CLI with shell-based install.sh

### Fixed

- Use commitizen version provider so cz bump has a file to commit
...
- Add three-tier execution mode — direct, plan mode, SDD

### Changed

- Clean up README — remove What's Included section, center badges
- Simplify README — consolidate sections, remove verbose details
...
- Remove specs 008 (session confidence) and 009 (dimensional confidence)
- Simplify specs 007/010, consolidate 3 rules into delegation.md

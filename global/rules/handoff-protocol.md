...
The orchestrator (Marvin) selects the appropriate level based on task complexity:

### Minimal
Simple, well-defined tasks with clear scope.

**Use for:** commits, formatting, simple file operations
...
### Standard
Most delegations requiring domain expertise.

**Use for:** creating models, research, implementing features, refactoring

**Required fields:**
- Objective
- Acceptance Criteria
- Constraints
- Context (key files, prior decisions, user preferences)
- Return Protocol

### Full
Complex tasks, retry attempts, or multi-step coordination.

**Use for:** debugging failures, complex integrations, tasks with error history

**Required fields:**
- All Standard fields
- Error History (previous attempts and failures)
- Detailed Background (architecture context, dependencies)

## Handoff Template

Use this exact markdown format when delegating:
...
### Constraints
MUST: <Required behaviors — non-negotiable>
MUST NOT: <Forbidden behaviors — violations fail the task>
PREFER: <Nice-to-have — follow when possible>

### Context
**Key Files:** <Paths + why they matter>
**Prior Decisions:** <Relevant decisions from this conversation>
**User Preferences:** <Applicable preferences from memory>

### Return Protocol
Report: <What to include in success response>
On failure: <How to report blockers>
On ambiguity: <When/how to ask for clarification>

### Error History (Full level only)
**Previous Attempt 1:** <What was tried, why it failed>
**Previous Attempt 2:** <What was tried, why it failed>

### Detailed Background (Full level only)
<Architecture context, dependencies, broader system knowledge>
```
...
### Constraints
MUST: Follow conventions in `~/.claude/rules/dbt.md`
